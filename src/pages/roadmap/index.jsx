...
export default function Component() {
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-semibold mb-8">👨‍🏫 Ok Ethan! Here is your roadmap:</h1>
              ...
              <AccordionItem value={`item-${index}`} className="border-none">
                <AccordionTrigger className="hover:no-underline px-6 py-4">
                  <div className="text-left">
                    <h2 className="text-xl font-medium text-gray-800">{chapter.name}</h2>
                    <p className="text-sm text-gray-600 mt-1">{chapter.hint}</p>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-6">
                  <div className="relative">
                    ...
                    <Button 
                      ...
                      onClick={() => window.location.href = chapter.redirectTo}
                    >
                      Start
                    </Button>
                  </div>
